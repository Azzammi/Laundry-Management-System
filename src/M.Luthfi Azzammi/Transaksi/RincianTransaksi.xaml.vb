...
Public Class RincianTransaksi
    ...
    Sub Record()
        Try
            Tabel = Proses.ExecuteQuery("SELECT * FROM Transaksi WHERE TglTransaksi <= '" & Format(CDate(Tgl1.Text), "yyyy-MM-dd") & "' AND TglTransaksi >= '" & Format(CDate(Tgl2.Text), "yyyy-MM-dd") & "'")
