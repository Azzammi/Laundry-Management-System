...
Public Class ViewPemakaianBarang2
    Public Sub New()
    ...
    Sub Record()
        Try
            Tabel = Proses.ExecuteQuery("SELECT * FROM PemakaianBarang")
    ...
    Private Sub SimpanBtn_Click(sender As Object, e As RoutedEventArgs) Handles SimpanBtn.Click
        ...
        Dim Barang As New PemakaianBarang2
        Barang.ShowDialog()
    End Sub
    ...
    Private Sub HapusBtn_Click(sender As Object, e As RoutedEventArgs) Handles HapusBtn.Click
        Try
            ...
            If Pesan = MessageBoxResult.Yes Then
                SQL = "DELETE FROM PemakaianBarang WHERE KodePengeluaran = '" + Rowview.Row(0).ToString + "'"
    ...
    Private Sub CariTxt_TextChanged(sender As Object, e As TextChangedEventArgs) Handles CariTxt.TextChanged
        Try
            Tabel = Proses.ExecuteQuery("SELECT * FROM Pemakaianbarang WHERE KodePengeluaran like '%" & CariTxt.Text & "%'")
            DG1.ItemsSource = Nothing
